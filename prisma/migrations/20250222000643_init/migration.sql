/*
  ...
  - You are about to drop the column `duration` on the `WorkExperience` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "WorkExperience" DROP COLUMN "duration",
